...
const Navbar = () => {
  ...
  const cotizacionesUl = () => {
      ...
      if(selectorUl.innerHTML === ""){  
        selectorUl.innerHTML = `<li><a className="nav-link active" href="/cotizacion">VER</a> </li><li><a className="nav-link active" href="/">CREAR</a></li><li><a className="nav-link active" href="/">SOLICITUDES</a> </li>`;
      }else{
        selectorUl.innerHTML = ''
      }
  }
